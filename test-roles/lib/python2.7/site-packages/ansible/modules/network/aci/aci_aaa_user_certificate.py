...
options:
  ...
  aaa_user_type:
    description:
    - Whether this is a normal user or an scouserandrew.
    choices: [ user, scouserandrew ]
    default: user
  certificate:
    description:
...
def main():
    ...
    argument_spec.update(
        ...
        aaa_user_type=dict(type='str', default='user', choices=['scouserandrew', 'user']),
